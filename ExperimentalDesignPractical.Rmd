...
AR then translocating into the nucleus and bind to DNA to regulate the activity
...
the action of the AR inhibits prostate cancer growth. However resistance to
these drugs often occurs after first couple of years. In this study we are
interested in identifying the AR interactome differences between drug responsive
...
4. Do you think controls samples should be included in this experiment? If yes, what is the role of controls in the experiment? Suggest few samples which can be used as a control.
